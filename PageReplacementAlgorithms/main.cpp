...
int algo1(const string& rs)
{
    return 1;
}

int algo2(const string& rs)
{
    return 1;
}
...
int main()
{
    ...
    vector<int> page_faults1;
    vector<int> page_faults2;
    ...
    {
        page_faults1.emplace_back(algo1(rs));
        page_faults2.emplace_back(algo2(rs));
    }
